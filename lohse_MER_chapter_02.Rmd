...
method, the f-observed for the main-effect of condition is F(2,78) = 208.8, p < 0.001. 
...
Most critically, note that the F-value, F(2,78) = 208.8, p < 0.001 is identical in 
...
produce the same f-observed for the main-effects of time, F(3,117) = 469.1, p < 0.001,
and Condition, F(2, 78) = 208.8, p < 0.001. 
