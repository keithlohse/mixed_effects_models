...
However, not that the Anova() function uses chi-squared tests, not F-tests these are different test statistics and while they generally yield similar conclusions, they will not necessarily yield the same conclusions.
