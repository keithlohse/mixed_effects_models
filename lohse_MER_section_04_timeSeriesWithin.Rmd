...
In this chapter, we are going to combine some of the concepts that we covered in [Section 2](https://keithlohse.github.io/mixed_effects_models/lohse_MER_section_02_longitudinal.html), on mixed-factorial designs, with [Section 3](https://keithlohse.github.io/mixed_effects_models/lohse_MER_section_03_factorial.html), on times series data. In combining these sections, we can see how we would analyze data when we have two time series that come from same person being measured at different times. 
