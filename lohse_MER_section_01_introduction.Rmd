...
* **Mixed-effect regression for time-series within factors**: Combining the two chapters above, I will explain how you can use mixed-effects to model time-series data within different conditions. Do you want to look at trial-by-trial effects under different conditions? Maybe you want to measure blood glucose levels after your subjects ate vegan cookies and celery (in a counter balanced order of course). If so, this chapter is for you. 
